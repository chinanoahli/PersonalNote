...
+ [Blender 学习笔记](./blender)

## 个人思考及经验总结 {#myArtNote}

### <span style="color: #000000; text-shadow: #FFFFFF 1px 1px 5px">000000.</span> 为何做笔记
...
### <span style="color: #000001; text-shadow: #FFFFFF 1px 1px 5px">000001.</span> 卷发的画法
...
### <span style="color: #000002; text-shadow: #FFFFFE 1px 1px 5px">000002.</span> 毛厂二阶段人体第 2 课作业的补充思考
...
现在在回过头来看步骤 *图 2-2* ，错误就很明显了：**<span style="color: #FF005D;"><i>我仅仅在原本的边所在的平面上找了一个靠下的为位置，而忽略了旋转之后的位置变化</i></span>**
...
<span style="color: #FF005D; font-size: 38px">**学习人体时不要同时跟多位老师学习**</span>
...
接下来就可以 [回到页面顶部](#美术学习笔记) 去看我在绘画中所获得的经验了
