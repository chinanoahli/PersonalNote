...
notHomePage: true
bookHidden: true
description: "How to Use SteamOS"
summary: "SteamOS 使用笔记"
---
...
> [!NOTE] 恢复镜像
>
> [点此跳转(需要翻墙)](https://help.steampowered.com/zh-cn/faqs/view/1B71-EDF2-EB6D-2BB3)
>
...
> [!WARNING]
>
> 不要使用任何第三方镜像软件源，SteamOS 使用的软件包均为 Valve 特选的版本，一旦使用第三方源的软件包进行更新，就有很大可能造成系统功能损坏的情况
...
其实没有这个图标也不影响你返回游戏模式，你只需要在桌面模式 **注销** 即可自动返回游戏模式

## SteamOS 默认设置调优

> [!CAUTION]
> 
> 本人已长时间没有测试本章节的内容，SteamOS 内核更新较快，此章节的调优方法很可能已不适用于最新版本
